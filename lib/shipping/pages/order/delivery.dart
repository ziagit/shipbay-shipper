...
import 'package:shipbay/shipping/models/delivery_address_model.dart';
...
class _DeliveryState extends State<Delivery> {
  ...
  _next(context) async {
    ...
    } else if (deliveryAddressModel.state != 'BC') {
      _scaffoldKey.currentState.showSnackBar(SnackBar(
        content: Text(
          "'${deliveryAddressModel.state}' is not in our courage yet!",
