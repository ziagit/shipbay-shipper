...
class CUstomerCardDetails extends StatefulWidget {
  @override
  _CUstomerCardDetailsState createState() => _CUstomerCardDetailsState();
}

class _CUstomerCardDetailsState extends State<CUstomerCardDetails> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        (_paymentStatus == null || _paymentStatus == false)
                            ? Align(
  ...
  _init() async {
    ...
    pendingOrder = await store.read('contacts');
  ...
  _charge() async {
    ...
    if (billing != null) {
      var response = await chargeCustomer(mover, billing, token);
      store.save('billing', {
