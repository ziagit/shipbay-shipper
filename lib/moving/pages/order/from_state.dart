...
class FromState extends StatefulWidget {
  @override
  _FromStateState createState() => _FromStateState();
}

class _FromStateState extends State<FromState> {
      ...
      body: ListView(
        children: <Widget>[
          Container(
            ...
            child: Column(
              children: <Widget>[
                SizedBox(child: Progress(progress: 6.0)),
                Container(
                  child: Column(
                    children: <Widget>[
                      Text(
  ...
  _init() async {
    var data = await store.read('from-state');
